...
files = [
    ...
    f'ipyeos-{version}-cp39-cp39-macosx_11_0_x86_64.whl',
    f'ipyeos-{version}-cp310-cp310-macosx_11_0_x86_64.whl',
    f'ipyeos-{version}-cp37-cp37m-macosx_11_0_x86_64.whl',
    f'ipyeos-{version}-cp38-cp38-macosx_11_0_x86_64.whl',
]
